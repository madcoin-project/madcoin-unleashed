...
static const int64_t MAX_MONEY = 55000000  * COIN; 
...
inline int64_t GetMNCollateral(int nHeight) { 
    if (nHeight > 278500) { return 25000; } else { return 10000; }
}

static const std::string blockedAddresses[] = {
    "MJ9FK8Lg3KV8CdkexZeh3pqgAy8dMv6cFN", 
    "MFdjpsaPtXELPtPryutQ1tSLyBBuxWz2Ds",
	"MD97w5b7QyudxoYHdkfXk4XDea1wzFCm17"
};
