...
#endif
	setObjectName("Madcoin");
	setStyleSheet("#Madcoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #ffffff, stop: 1 #ffffff);  }");
	// Accept D&D of URIs
	setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setToolTip(tr("Send coins to a Madcoin address"));
	...
	pioAction = new QAction(QIcon(":/icons/website"), tr("&Madcoin Website"), this);
	pioAction->setToolTip(tr("Visit the Official Madcoin website"));
    ...
    chainAction = new QAction(QIcon(":/icons/discord"), tr("&Madcoin Discord"), this);
    chainAction->setToolTip(tr("Join Madcoin Discord"));
    explorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Madcoin Explorer"), this);
	explorerAction->setToolTip(tr("Madcoin Explorer"));	
	...
	aboutAction->setToolTip(tr("Show information about Madcoin"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setToolTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setToolTip(tr("Modify configuration options for Madcoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
	...
	if (clientModel)
	{
		...
		if (clientModel->isTestNet())
		{
			...
			if (trayIcon)
			{
				trayIcon->setToolTip(tr("Madcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
	if (event->mimeData()->hasUrls())
	{
		...
		if (nValidUrisFound)
			...
			notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Madcoin address or malformed URI parameters."));
	}
...
{
    QDesktopServices::openUrl(QUrl("https://madcoin.io"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("https://bitcointalk.org/index.php?topic=5139608"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("https://discord.gg/tYdG9MM"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("http://explorer.madcoin.io"));
}
