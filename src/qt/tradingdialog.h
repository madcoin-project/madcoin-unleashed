...
private slots:
    ...
    QString BuyMDC(QString OrderType, double Quantity, double Rate);
    QString SellMDC(QString OrderType, double Quantity, double Rate);
